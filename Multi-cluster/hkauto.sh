...
#This is the auto script for creating ticket
#It works but it still can be optimized
#author: LL
...
luis_folder_dir="/app/sword/schenker/support/luis/auto"


[[ $1 == "" ]] && echo -e "Please Input the specific node name!" && echo -e "Usage: hkauto.sh {node}" && exit
if [[ $1 != "3A" && $1 != "3B" && $1 != "3C" && $1 != "3D" && $1 != "3E" && $1 != "3F" && $1 != "2B" && $1 != "2C" \
  && $1 != "3a" && $1 != "3b" && $1 != "3c" && $1 != "3d" && $1 != "3e" && $1 != "3f" && $1 != "2b"  && $1 != "2c" ]];
  then echo -e "Please input the correct node name!";
       exit
  else echo -e "Success!"
fi
